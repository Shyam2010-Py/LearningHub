  ...
  function buildFooter() {
    return `
      <footer class="site-footer">
        <div>
          <strong>LogicLab</strong> <span class="footer-version">v1.0.2</span>
        </div>
        ...
        <div style="margin-top:0.75rem;">
          <a href="../../" style="color:var(--primary,#2563EB);text-decoration:none;font-weight:600;font-size:0.85rem;">← Back to Student Hub</a>
        </div>
      </footer>
    `;
  }
